...
//    signal(SIGHUP, SIG_IGN);
    ...
    memcpy(str, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.9.6132.135 Safari/537.36", 115); // WinOS Common UA
